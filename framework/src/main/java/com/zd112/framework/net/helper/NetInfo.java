...
public class NetInfo {
    ...
    public static final class Builder {
        ...
        public Builder setClass(Class _class) {
            this._class = _class;
            return this;
        }
        ...
        public Builder setAction(String url) {
    ...
    public NetInfo packInfo(int netCode, int retCode, String retDetail) {
    ...
    public void setCass(Class _class) {
        this._class = _class;
    }
    ...
    public <T> T getResponseObj() {
        return (T) myGson().fromJson(retDetail, _class);
    }
