...
import static com.zd112.framework.view.refresh.util.ScrollBoundaryUtil.canScrollDown;
import static com.zd112.framework.view.refresh.util.ScrollBoundaryUtil.canScrollUp;
import static com.zd112.framework.view.refresh.util.ScrollBoundaryUtil.isTransformedTouchPointInView;
import static com.zd112.framework.view.refresh.util.SmartUtil.isScrollableView;
import static com.zd112.framework.view.refresh.util.SmartUtil.measureViewHeight;
import static com.zd112.framework.view.refresh.util.SmartUtil.scrollListBy;

@SuppressWarnings("WeakerAccess")
public class RefreshContentWrapper implements RefreshContent, AnimatorUpdateListener {
