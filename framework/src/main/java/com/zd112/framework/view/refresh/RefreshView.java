package com.zd112.framework.view.refresh;
...
import com.zd112.framework.view.refresh.interfaces.DefaultRefreshHeaderCreator;
import com.zd112.framework.view.refresh.interfaces.OnLoadMoreListener;
import com.zd112.framework.view.refresh.interfaces.OnMultiPurposeListener;
import com.zd112.framework.view.refresh.interfaces.OnRefreshListener;
import com.zd112.framework.view.refresh.interfaces.OnRefreshLoadMoreListener;
import com.zd112.framework.view.refresh.interfaces.OnStateChangedListener;
import com.zd112.framework.view.refresh.interfaces.RefreshContent;
...
import com.zd112.framework.view.refresh.interfaces.SimpleMultiPurposeListener;
import com.zd112.framework.view.refresh.util.DelayedRunnable;
...
import com.zd112.framework.view.refresh.wrapper.RefreshContentWrapper;
import com.zd112.framework.view.refresh.wrapper.RefreshFooterWrapper;
import com.zd112.framework.view.refresh.wrapper.RefreshHeaderWrapper;
...
import static com.zd112.framework.view.refresh.util.SmartUtil.fling;
import static com.zd112.framework.view.refresh.util.SmartUtil.getColor;
import static com.zd112.framework.view.refresh.util.SmartUtil.isScrollableView;
import static java.lang.System.currentTimeMillis;

@SuppressLint("RestrictedApi")
@SuppressWarnings({"unused", "WeakerAccess"})
public class RefreshView extends ViewGroup implements RefreshLayout, NestedScrollingParent, NestedScrollingChild {
    ...
    public RefreshView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mHeaderHeight = ta.getDimensionPixelOffset(R.styleable.RefreshView_rfHeaderHeight, DimenUtils.dip2px(100));
        mFooterHeight = ta.getDimensionPixelOffset(R.styleable.RefreshView_rfFooterHeight, DimenUtils.dip2px(60));
    ...
    protected void onAttachedToWindow() {
        ...
        if (!thisView.isInEditMode()) {
            ...
            if (mRefreshContent == null) {
                final int padding = DimenUtils.dp2px(20);
            ...
            if (!mManualNestedScrolling && !isNestedScrollingEnabled()) {
                post(new Runnable() {
                    @Override
                    public void run() {
                        final View thisView = RefreshView.this;
                        for (ViewParent parent = thisView.getParent(); parent != null; ) {
                            if (parent instanceof NestedScrollingParent) {
                                View target = RefreshView.this;
        ...
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mRefreshListener != null) {
                    mRefreshListener.onRefresh(RefreshView.this);
                } else if (mOnMultiPurposeListener == null) {
                    finishRefresh(3000);
                }
                if (mRefreshHeader != null) {
                    mRefreshHeader.onStartAnimator(RefreshView.this, mHeaderHeight, (int) (mHeaderMaxDragRate * mHeaderHeight));
                }
                if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    mOnMultiPurposeListener.onRefresh(RefreshView.this);
...
//                mVelocity *= Math.pow(mDamping, ++mFrame);
        ...
        public void run() {
            if (animationRunnable == this && !mState.isFinishing) {
                ...
                if (Math.abs(velocity) >= 1) {
                    ...
                    animationRunnable = null;
                    if (Math.abs(mSpinner) >= Math.abs(mSmoothDistance)) {
                        int duration = 10 * Math.min(Math.max((int) DimenUtils.px2dp(Math.abs(mSpinner - mSmoothDistance)), 30), 100);
    ...
    @Override
    public RefreshView setFooterHeight(float heightDp) {
        if (mFooterHeightStatus.canReplaceWith(DimensionStatus.CodeExact)) {
            mFooterHeight = DimenUtils.dp2px(heightDp);
    ...
    @Override
    public RefreshView setHeaderHeight(float heightDp) {
        if (mHeaderHeightStatus.canReplaceWith(DimensionStatus.CodeExact)) {
            mHeaderHeight = DimenUtils.dp2px(heightDp);
    ...
    @Override
    public RefreshView setHeaderInsetStart(float insetDp) {
        mHeaderInsetStart = DimenUtils.dp2px(insetDp);
        return this;
    }

    @Override
    public RefreshView setFooterInsetStart(float insetDp) {
        mFooterInsetStart = DimenUtils.dp2px(insetDp);
        return this;
    }
     ...
     */
    @Override
    public RefreshView setDragRate(float rate) {
        this.mDragRate = rate;
        return this;
    }
     ...
     */
    @Override
    public RefreshView setHeaderMaxDragRate(float rate) {
     ...
     */
    @Override
    public RefreshView setFooterMaxDragRate(float rate) {
     ...
     */
    @Override
    public RefreshView setHeaderTriggerRate(float rate) {
     ...
     */
    @Override
    public RefreshView setFooterTriggerRate(float rate) {
     ...
     */
    @Override
    public RefreshView setReboundInterpolator(@NonNull Interpolator interpolator) {
     ...
     */
    @Override
    public RefreshView setReboundDuration(int duration) {
     ...
     */
    @Override
    public RefreshView setEnableLoadMore(boolean enabled) {
     ...
     */
    @Override
    public RefreshView setEnableRefresh(boolean enabled) {
     ...
     */
    @Override
    public RefreshView setEnableHeaderTranslationContent(boolean enabled) {
     ...
     */
    @Override
    public RefreshView setEnableFooterTranslationContent(boolean enabled) {
     ...
     */
    @Override
    public RefreshView setEnableAutoLoadMore(boolean enabled) {
     ...
     */
    @Override
    public RefreshView setEnableOverScrollBounce(boolean enabled) {
     ...
     */
    @Override
    public RefreshView setEnablePureScrollMode(boolean enabled) {
     ...
     */
    @Override
    public RefreshView setEnableScrollContentWhenLoaded(boolean enabled) {
     ...
     */
    @Override
    public RefreshView setEnableScrollContentWhenRefreshed(boolean enabled) {
     ...
     */
    @Override
    public RefreshView setEnableLoadMoreWhenContentNotFull(boolean enabled) {
     ...
     */
    @Override
    public RefreshView setEnableOverScrollDrag(boolean enabled) {
     ...
     */
    @Override
    public RefreshView setEnableFooterFollowWhenLoadFinished(boolean enabled) {
     ...
     */
    @Override
    public RefreshView setEnableClipHeaderWhenFixedBehind(boolean enabled) {
     ...
     */
    @Override
    public RefreshView setEnableClipFooterWhenFixedBehind(boolean enabled) {
     ...
     */
    @Override
    public RefreshView setDisableContentWhenRefresh(boolean disable) {
     ...
     */
    @Override
    public RefreshView setDisableContentWhenLoading(boolean disable) {
     ...
     */
    @Override
    public RefreshView setRefreshHeader(@NonNull RefreshHeader header) {
     ...
     */
    @Override
    public RefreshView setRefreshHeader(@NonNull RefreshHeader header, int width, int height) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public RefreshView setRefreshFooter(@NonNull RefreshFooter footer) {
     ...
     */
    @Override
    public RefreshView setRefreshFooter(@NonNull RefreshFooter footer, int width, int height) {
        if (mRefreshFooter != null) {
     ...
     */
    @Override
    public RefreshView setOnRefreshListener(OnRefreshListener listener) {
     ...
     */
    @Override
    public RefreshView setOnLoadMoreListener(OnLoadMoreListener listener) {
     ...
     */
    @Override
    public RefreshView setOnRefreshLoadMoreListener(OnRefreshLoadMoreListener listener) {
        this.mRefreshListener = listener;
        this.mLoadMoreListener = listener;
        this.mEnableLoadMore = mEnableLoadMore || (!mManualLoadMore && listener != null);
        return this;
     ...
     */
    @Override
    public RefreshView setOnMultiPurposeListener(OnMultiPurposeListener listener) {
     ...
     */
    @Override
    public RefreshView setPrimaryColors(@ColorInt int... primaryColors) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public RefreshView setPrimaryColorsId(@ColorRes int... primaryColorId) {
        final View thisView = this;
     ...
     */
    @Override
    public RefreshView setScrollBoundaryDecider(ScrollBoundaryDecider boundary) {
     ...
     */
    @Override
    public RefreshView setNoMoreData(boolean noMoreData) {
     ...
     */
    @Override
    public RefreshView finishRefresh() {
     ...
     */
    @Override
    public RefreshView finishLoadMore() {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public RefreshView finishRefresh(int delayed) {
     ...
     */
    @Override
    public RefreshView finishRefresh(boolean success) {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public RefreshView finishRefresh(int delayed, final boolean success) {
        postDelayed(new Runnable() {
            ...
            public void run() {
                if (mState == RefreshState.Refreshing && mRefreshHeader != null && mRefreshContent != null) {
                    ...
                    int startDelay = mRefreshHeader.onFinish(RefreshView.this, success);
                    if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            RefreshView.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mLastTouchY + mSpinner - mTouchSlop * 2, 0));
                            RefreshView.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mLastTouchY + mSpinner, 0));
     ...
     */
    @Override
    public RefreshView finishLoadMore(int delayed) {
     ...
     */
    @Override
    public RefreshView finishLoadMore(boolean success) {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public RefreshView finishLoadMore(int delayed, final boolean success, final boolean noMoreData) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (mState == RefreshState.Loading && mRefreshFooter != null && mRefreshContent != null) {
                    notifyStateChanged(RefreshState.LoadFinish);
                    final int startDelay = mRefreshFooter.onFinish(RefreshView.this, success);
                    if (mOnMultiPurposeListener != null && mRefreshFooter instanceof RefreshFooter) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        ...
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            RefreshView.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mLastTouchY + offset + mTouchSlop * 2, 0));
                            RefreshView.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mLastTouchY + offset, 0));
                            if (mNestedInProgress) {
                                mTotalUnconsumed = 0;
                            }
                        }
     ...
     */
    @Override
    public RefreshView finishLoadMoreWithNoMoreData() {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
    ...
    public class RefreshKernelImpl implements RefreshKernel {
        ...
        public ValueAnimator animSpinner(int endSpinner) {
            return RefreshView.this.animSpinner(endSpinner, 0, mReboundInterpolator, mReboundDuration);
        }
